...
def talker():
	...
	ap.add_argument("-v", "--video", dest="/home/mk1582/catkin_ws/src/ros_seminar/scripts/ball_tracking_example.mp4",help="path")
	ap.add_argument("-b", "--buffer", type=int, default=64,help="max buffer size")
	args = vars(ap.parse_args())

	greenLower = (139,0,0)#(29, 86, 6)
	greenUpper = (255,160,122)#(64, 255, 255)
	pts = deque(maxlen=64)
